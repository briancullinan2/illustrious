...
var $ = (s, e, r, t) => {
    ...
    ;
var Z = (s, e, r) => (r = s != null ? j(z(s)) : {},
    $(e || !s || !s.__esModule ? P(r, "default", {
        value: s,
        enumerable: !0
    }) : r, s));
var q = X((Ze, H) => {
...
var re = (n => (n[n.IDENTIFIER = 0] = "IDENTIFIER",
    ...
    n))(re || {});
var te = (i => (i[i.NONE = 0] = "NONE",
    i[i.DEBUG = 1] = "DEBUG",
    i[i.INFO = 2] = "INFO",
    i[i.WARNING = 3] = "WARNING",
    i[i.ERROR = 4] = "ERROR",
    i))(te || {})
    , se = (n => (n[n.NONE = 0] = "NONE",
...
var ie = (t => (t[t.SUCCESS = 0] = "SUCCESS",
...
var E = class {
    ...
    async query(e) {
        ...
        let r = await this._bindings.runQuery(this._conn, e)
            , t = u.RecordBatchReader.from(r);
        return console.assert(t.isSync(), "Reader is not sync"),
    ...
    async send(e, r = !1) {
        ...
        let o = new p(this._bindings, this._conn, t)
            , i = await u.RecordBatchReader.from(o);
        return console.assert(i.isAsync()),
            console.assert(i.isStream()),
            i
    }
    async cancelSent() {
    ...
    , p = class {
        ...
        async next() {
            ...
            let e = null;
            for (this._inFlight != null && (e = await this._inFlight,
                this._inFlight = null); e == null;)
                e = await this.db.fetchQueryResults(this.conn);
            return this._depleted = e.length == 0,
                this._depleted || (this._inFlight = this.db.fetchQueryResults(this.conn)),
            {
                done: this._depleted,
                value: e
            }
    ...
    , b = class {
        ...
        async query(...e) {
            let r = await this.bindings.runPrepared(this.connectionId, this.statementId, e)
                , t = u.RecordBatchReader.from(r);
            return console.assert(t.isSync()),
                console.assert(t.isFile()),
                new u.Table(t)
        }
        async send(...e) {
            let r = await this.bindings.sendPrepared(this.connectionId, this.statementId, e)
                , t = new p(this.bindings, this.connectionId, r)
                , o = await u.RecordBatchReader.from(t);
            return console.assert(o.isAsync()),
                console.assert(o.isStream()),
                o
        }
    }
    ;
var D = (c => (c.CANCEL_PENDING_QUERY = "CANCEL_PENDING_QUERY",
    ...
    c.TOKENIZE = "TOKENIZE",
    c))(D || {})
    , O = (l => (l.CONNECTION_INFO = "CONNECTION_INFO",
        l.ERROR = "ERROR",
...
function _(s) {
    switch (s.typeId) {
        ...
        case d.Type.IntervalDayTime:
            return {
                sqlType: "interval[dt]"
            };
        case d.Type.IntervalYearMonth:
            return {
                sqlType: "interval[m]"
            };
        case d.Type.List:
        ...
        case d.Type.TimeMicrosecond:
            return {
                sqlType: "time[us]"
            };
        case d.Type.TimeMillisecond:
            return {
                sqlType: "time[ms]"
            };
        case d.Type.TimeNanosecond:
            return {
                sqlType: "time[ns]"
            };
        case d.Type.TimeSecond:
            return {
                sqlType: "time[s]"
            };
        ...
        case d.Type.TimestampSecond:
            return {
                sqlType: "timestamp[s]",
                timezone: s.timezone || void 0
            };
        case d.Type.TimestampMicrosecond:
            return {
                sqlType: "timestamp[us]",
                timezone: s.timezone || void 0
            };
        case d.Type.TimestampNanosecond:
            return {
                sqlType: "timestamp[ns]",
                timezone: s.timezone || void 0
            };
        case d.Type.TimestampMillisecond:
            return {
...
var ce = new TextEncoder
    , f = class {
        ...
        detach() {
            this._worker && (this._worker.removeEventListener("message", this._onMessageHandler),
        ...
        async postTask(e, r = []) {
            ...
            return this._pendingRequests.set(t, e),
        ...
        onMessage(e) {
            ...
            if (this._pendingRequests.delete(r.requestId),
                r.type == "ERROR") {
                let i = new Error(r.data.message);
                i.name = r.data.name,
                    (o = Object.getOwnPropertyDescriptor(i, "stack")) != null && o.writable && (i.stack = r.data.stack),
                    t.promiseRejecter(i);
                return
            }
            switch (t.type) {
                ...
                case "RESET":
                    ...
                    break;
                case "INSTANTIATE":
                    if (this._onInstantiationProgress = [],
                        r.type == "OK") {
                        t.promiseResolver(r.data);
                        return
                    }
        ...
        onClose() {
            if (this._workerShutdownResolver(null),
        ...
        async registerOPFSFileFromSQL(e) {
            ...
            for (let o of r)
                try {
                    await this.registerOPFSFileName(o),
                        t.push(o)
                } catch (i) {
                    throw console.error(i),
                    new Error("File Not found:" + o)
                }
            return t
        }
    }
...
function le() {
    ...
    return e => (typeof SharedArrayBuffer < "u" && e.buffer instanceof SharedArrayBuffer && (e = new Uint8Array(e)),
        s.decode(e))
}
var Be = le();
var w = (n => (n[n.BUFFER = 0] = "BUFFER",
        ...
        try {
            switch (e.type) {
                ...
                case "OPEN":
                    {
                        let r = e.data.path;
                        r != null && r.startsWith("opfs://") && (await this._bindings.prepareDBFileHandle(r, 3),
                ...
                case "DROP_FILE":
                    this._bindings.dropFile(e.data),
                        this.sendOK(e);
                    break;
                case "DROP_FILES":
                    this._bindings.dropFiles(e.data),
                        this.sendOK(e);
                    break;
                case "FLUSH_FILES":
                ...
                case "DISCONNECT":
                    this._bindings.disconnect(e.data),
                        this.sendOK(e);
                    break;
                case "CREATE_PREPARED":
                    {
                ...
                case "CLOSE_PREPARED":
                    {
                        this._bindings.closePrepared(e.data[0], e.data[1]),
                            this.sendOK(e);
                        break
                    }
                case "RUN_PREPARED":
                ...
                case "START_PENDING_QUERY":
                    {
                        let r = this._bindings.startPendingQuery(e.data[0], e.data[1], e.data[2])
                            , t = [];
                        r && t.push(r.buffer),
                            this.postMessage({
                                messageId: this._nextMessageId++,
                ...
                case "REGISTER_FILE_URL":
                    this._bindings.registerFileURL(e.data[0], e.data[1], e.data[2], e.data[3]),
                        this.sendOK(e);
                    break;
                case "REGISTER_FILE_BUFFER":
                    ...
                    break;
                case "REGISTER_FILE_HANDLE":
                    await this._bindings.registerFileHandleAsync(e.data[0], e.data[1], e.data[2], e.data[3]),
                        this.sendOK(e);
                    break;
                case "COPY_FILE_TO_PATH":
                    this._bindings.copyFileToPath(e.data[0], e.data[1]),
                        this.sendOK(e);
                    break;
                case "COPY_FILE_TO_BUFFER":
                    {
...
var m = {
    ...
    files: ["dist", "!dist/tests-*", "!dist/duckdb-browser-mvp.worker.js.map", "!dist/types/test"],
...
var k = null
    ...
    , h = null;
async function pe() {
    return k == null && (k = typeof BigInt64Array < "u"),
        y == null && (y = await W()),
        g == null && (g = await B()),
        S == null && (S = await v()),
        h == null && (h = await U()),
