...
function ht(t, e) {
	if(null != t)
		if("string" == typeof t)
			...
			if(x(t))
				t = t.length ? new F(new Uint8Array(t), L) : R();
			else {
				if(!e)
					throw Error();
				t = void 0;
...
class ut {
	...
	next() {
		const t = this.g.next();
		return t.done || (t.value = this.h.call(this.l, t.value)),
			t;
	}
	[Symbol.iterator]() {
		return this;
...
function Et(t) {
	...
	} else if(mt(e) && !Number.isSafeInteger(e))
		throw Error(String(e));
...
function Ut(t, e) {
	if(t >>>= 0,
		...
		D() ? n = "" + (BigInt(e) << BigInt(32) | BigInt(t)) : (t = (16777215 & t) + 6777216 * (n = 16777215 & (t >>> 24 | e << 8)) + 6710656 * (e = e >> 16 & 65535),
			n += 8147497 * e,
			e *= 2,
			t >= 1e7 && (n += t / 1e7 >>> 0,
				t %= 1e7),
...
function Gt(t) {
	if(t.length < 16)
		...
		for(let r = e, i = (n - e) % 6 + e; i <= n; r = i,
			...
			It *= 1e6,
				Rt = 1e6 * Rt + e,
				Rt >= 4294967296 && (It += Math.trunc(Rt / 4294967296),
					It >>>= 0,
					Rt >>>= 0);
		}
		if(e) {
...
function qt(t) {
	if(null != t && "number" != typeof t)
		throw Error(`Value of float/double field must be a number, found ${typeof t}: ${t}`);
	return t;
}
function $t(t) {
...
function re(t) {
	const e = t.length;
	return ("-" === t[0] ? e < 20 || 20 === e && t <= "-9223372036854775808" : e < 19 || 19 === e && t <= "9223372036854775807") ? t : (Gt(t),
		Bt(Rt, It));
}
function ie(t) {
	if(t = Kt(t),
...
function se(t) {
	var e = Kt(Number(t));
	return Wt(e) ? String(e) : (-1 !== (e = t.indexOf(".")) && (t = t.substring(0, e)),
		re(t));
}
function oe(t) {
	var e = Kt(Number(t));
	return Wt(e) ? Et(e) : (-1 !== (e = t.indexOf(".")) && (t = t.substring(0, e)),
		D() ? Et(Xt(64, BigInt(t))) : Et(re(t)));
}
function ae(t) {
	return Wt(t) ? t = Et(ie(t)) : (t = Kt(t),
		Wt(t) ? t = String(t) : (Mt(t),
			t = Bt(Rt, It)),
		t = Et(t)),
		t;
}
...
function fe(t, e, n, r) {
	return null != t && t[q] === ot ? t : Array.isArray(t) ? ((r = (n = 0 | t[Q]) | 32 & r | 2 & r) !== n && rt(t, r),
		new e(t)) : (n ? 2 & r ? ((t = e[V]) || (it((t = new e).v),
			t = e[V] = t),
...
const ye = ge ? (Object.setPrototypeOf(me.prototype, Map.prototype),
...
var Ee = class extends ye {
	constructor(t, e, n = _e, r = _e) {
		...
		for(let i = 0; i < t.length; i++) {
			const s = t[i]
				, o = n(s[0], !1, !0);
			let a = s[1];
			e ? void 0 === a && (a = null) : a = r(s[1], !1, !0, void 0, void 0, this.J),
				super.set(o, a);
		}
	}
	V(t) {
	...
	set(t, e) {
		return ve(this),
			null == (t = this.S(t, !0, !1)) ? this : null == e ? (super.delete(t),
				this) : super.set(t, this.fa(e, !0, !0, this.K, !1, this.J));
	}
	Ma(t) {
		const e = this.S(t[0], !1, !0);
		t = t[1],
			t = this.K ? void 0 === t ? null : t : this.fa(t, !1, !0, void 0, !1, this.J),
			super.set(e, t);
	}
	has(t) {
	...
	get(t) {
		...
		if(void 0 !== e) {
			var n = this.K;
			return n ? ((n = this.fa(e, !1, !0, n, this.ra, this.J)) !== e && super.set(t, n),
				n) : e;
		}
	}
	[Symbol.iterator]() {
...
function Ie(t, e, n, r) {
	...
	1 & e || (c = a && t[a - 1],
		null != c && "object" == typeof c && c.constructor === Object ? s = --a : c = void 0,
		!u || 128 & e || i || (h = !0,
			s = s - l + l)),
		e = void 0;
	for(var f = 0; f < a; f++) {
	...
	if(c)
		for(let t in c) {
			if(null == (a = c[t]) || null == (a = n(a, r)))
				continue;
			let i;
			f = +t,
				u && !Number.isNaN(f) && (i = f + l) < s ? o[i] = a : (e ??= {})[t] = a;
		}
	return e && (h ? o.push(e) : o[s] = e),
		i && H && (t = ke(t)) && t instanceof xe && (o[H] = function (t) {
			const e = new xe;
			return Se(t, ((t, n, r) => {
				e[n] = Vt(r);
			}
	...
	if(t instanceof Ee) {
		...
		if(n = it(t.V()),
			...
			for(t = 0; t < n.length; t++) {
				const r = n[t];
				let i = r[1];
				i = null == i || "object" != typeof i ? void 0 : null != i && i[q] === ot ? je(i) : Array.isArray(i) ? Be(i, 0 | i[Q], !!(32 & e)) : void 0,
					r[1] = i;
			}
		return n;
	}
...
function Be(t, e, n) {
	return 2 & e || (!n || 4096 & e || 16 & e ? t = Ve(t, e, !1, n && !(16 & e)) : (nt(t, 34),
		4 & e && Object.freeze(t))),
		t;
}
function Ge(t, e, n) {
	return t = new t.constructor(e),
		n && (t.h = ct),
		t.m = ct,
		t;
}
...
function We(t) {
	if(!He(t) && at(t, 0 | t.v[Q]))
		throw Error();
}
function ze(t, e) {
	void 0 === e && (e = 0 | t[Q]),
		32 & e && !(4096 & e) && rt(t, 4096 | e);
}
function Ke(t, e, n) {
	return !!(2 & n) || !(!(32 & n) || 4096 & n) && (rt(e, 2 | n),
		t.h = ct,
		!0);
}
const Ye = Et(0)
...
function $e(t, e, n, r, i) {
	if(null !== (e = Je(t.v, e, n, i)) || r && t.m !== ct)
		return e;
}
function Je(t, e, n, r) {
	if(-1 === e)
...
function Qe(t, e, n, r, i) {
	...
	return s <= o ? (t[s] = r,
		e) : (void 0 !== r && (n >= (o = (e ??= 0 | t[Q]) >> 14 & 1023 || 536870912) ? null != r && (t[o + (i ? 0 : -1)] = {
			[n]: r
		}) : t[s] = r),
			e);
}
...
function nn(t, e, n, r, i, s, o, a) {
	let c = e;
	return 1 === s || 4 === s && (2 & e || !(16 & e) && 32 & r) ? on(e) || ((e |= !t.length || o && !(4096 & e) || 32 & r && !(4096 & e || 16 & e) ? 2 : 256) !== c && rt(t, e),
		Object.freeze(t)) : (2 === s && on(e) && (t = Vt(t),
			c = 0,
			e = An(e, r),
			r = Qe(n, r, i, t)),
			on(e) || (a || (e |= 16),
...
function hn(t, e, n, r) {
	We(t),
		Qe(t = t.v, 0 | t[Q], e, ("0" === r ? 0 === Number(n) : n === r) ? void 0 : n);
}
function un(t, e, n) {
	if(2 & e)
		throw Error();
	...
	let i = rn(t, n, r)
		, s = i === tt ? 7 : 0 | i[Q]
		, o = sn(s, e);
	return (2 & o || on(o) || 16 & o) && (o === s || on(o) || rt(i, o),
		i = Vt(i),
		s = 0,
		o = An(o, e),
		Qe(t, e, n, i, r)),
...
function dn(t, e, n, r, i) {
	const s = fn(t)
		, o = pn(s, t, e, n, i);
	return o !== r && (o && (e = Qe(t, e, o, void 0, i)),
		s.set(n, r)),
		e;
}
function pn(t, e, n, r, i) {
	...
	for(let t = 0; t < r.length; t++) {
		const o = r[t];
		null != Je(e, o, i) && (0 !== s && (n = Qe(e, n, s, void 0, i)),
			s = o);
	}
	return t.set(r, s),
		s;
...
function mn(t, e, n, r, i) {
	...
	if(null != (r = Je(t, r, i, (t => {
		...
		return s && !at(r) && ze(t, e),
			r;
}
function yn(t, e, n, r) {
	let i = t.v
		, s = 0 | i[Q];
	if(null == (e = mn(i, s, e, n, r)))
		return e;
	if(s = 0 | i[Q],
		!at(t, s)) {
		const o = Xe(e);
...
function _n(t, e, n, r, i, s, o, a) {
	...
	if(u !== h && (rt(t, u),
		2 & u && Object.freeze(t)),
		c && !(8 & u || !t.length && (1 === s || 4 === s && (2 & u || !(16 & u) && 32 & n)))) {
		for(on(u) && (t = Vt(t),
			u = An(u, n),
			n = Qe(e, n, i, t)),
			r = t,
			...
			(l = r[h]) !== (u = Xe(l)) && (r[h] = u);
		c |= 8,
			rt(t, u = c = r.length ? 4096 | c : -4097 & c);
	}
...
function Pn(t, e) {
	if("string" == typeof t)
		return new Mn(S(t), e);
	if(Array.isArray(t))
		return new Mn(new Uint8Array(t), e);
	...
	if(t.constructor === ArrayBuffer)
		return t = new Uint8Array(t),
			new Mn(t, !1);
	if(t.constructor === F)
		return e = I(t) || new Uint8Array(0),
			new Mn(e, !0, t);
	if(t instanceof Uint8Array)
		return t = t.constructor === Uint8Array ? t : new Uint8Array(t.buffer, t.byteOffset, t.byteLength),
			new Mn(t, !1);
	throw Error();
}
function Cn(t, e) {
...
function Dn(t) {
	...
	return e = e[n + 3],
		Gn(t, t.g + 4),
		t = 2 * ((i = (r << 0 | i << 8 | s << 16 | e << 24) >>> 0) >> 31) + 1,
		r = i >>> 23 & 255,
		i &= 8388607,
		255 == r ? i ? NaN : t * (1 / 0) : 0 == r ? 1401298464324817e-60 * t * i : t * Math.pow(2, r - 150) * (i + 8388608);
}
function Bn(t) {
	return Nn(t);
}
...
function Vn(t, e) {
	if(0 == e)
		return R();
	var n = jn(t, e);
	return t.Y && t.j ? n = t.h.subarray(n, n + e) : (t = t.h,
		n = n === (e = n + e) ? new Uint8Array(0) : xt ? t.slice(n, e) : new Uint8Array(t.subarray(n, e))),
...
function qn(t) {
	...
	if(t = t.h,
		...
		for(; u < e;) {
			var l = t[u++];
			l < 128 ? a.push(l) : l < 224 ? u >= e ? n() : (i = t[u++],
				l < 194 || 128 != (192 & i) ? (u--,
					n()) : a.push((31 & l) << 6 | 63 & i)) : l < 240 ? u >= e - 1 ? n() : (i = t[u++],
						128 != (192 & i) || 224 === l && i < 160 || 237 === l && i >= 160 || 128 != (192 & (c = t[u++])) ? (u--,
							n()) : a.push((15 & l) << 12 | (63 & i) << 6 | 63 & c)) : l <= 244 ? u >= e - 2 ? n() : (i = t[u++],
								128 != (192 & i) || i - 144 + (l << 28) >> 30 != 0 || 128 != (192 & (c = t[u++])) || 128 != (192 & (h = t[u++])) ? (u--,
									n()) : (l = (7 & l) << 18 | (63 & i) << 12 | (63 & c) << 6 | 63 & h,
										l -= 65536,
										a.push(55296 + (l >> 10 & 1023), 56320 + (1023 & l)))) : n(),
				a.length >= 8192 && (s = r(s, a),
					a.length = 0);
		}
		u = r(s, a);
	}
...
var Zn = class {
	...
	, Qn = [];
function tr(t) {
	return t ? /^\d+$/.test(t) ? (Gt(t),
		new er(Rt, It)) : null : nr ||= new er(0, 0);
}
var er = class {
	constructor(t, e) {
		this.h = t >>> 0,
...
function rr(t) {
	return t ? /^-?\d+$/.test(t) ? (Gt(t),
		new ir(Rt, It)) : null : sr ||= new ir(0, 0);
}
var ir = class {
	constructor(t, e) {
		this.h = t >>> 0,
...
function jr(t, e, n, r) {
	...
	var s = r[1];
	let o = 1;
	s && s.constructor === Object && (i.ba = s,
		"function" == typeof (s = r[++o]) && (i.ma = !0,
			Br ??= s,
			Gr ??= r[o + 1],
			s = r[o += 2]));
	const a = {};
	...
	return e = n.ma ? (t, e) => Br(t, e, n) : (t, e) => {
		for(; zn(e) && 4 != e.h;) {
			...
			if(null == i || !i(e, t, r)) {
				...
				i = void 0,
					s = t,
					o && ((i = s[H] ?? (s[H] = new xe))[r] ?? (i[r] = [])).push(o);
			}
		}
		return (t = ke(t)) && (t.da = n.qa[Dr]),
			!0;
	}
		,
		t[Nr] = e,
...
var ii = Ir((function (t, e, n, r, i) {
	if(2 !== t.h)
		return !1;
	if(t = Vt(t = Yn(t, Ne([void 0, void 0], r), i)),
		i = pt(r = 0 | e[Q]),
		2 & r)
		throw Error();
	let s = Je(e, n, i);
			...
			typeof e) {
				...
				case "bigint":
					n = BigInt.asUintN(64, e),
						n = new ir(Number(n & BigInt(4294967295)), Number(n >> BigInt(32))),
						or(t.g, n.h, n.g);
					break;
				default:
					n = rr(e),
...
function ai(t, e, n) {
	null != (e = ee(e)) && null != e && (lr(t, n, 0),
		cr(t.g, e));
}
function ci(t, e, n) {
	null != (e = Zt(e)) && (lr(t, n, 0),
		t.g.g.push(e ? 1 : 0));
}
function hi(t, e, n) {
...
function fi(t, e, n) {
	null != (e = ne(e)) && null != e && (lr(t, n, 0),
		ar(t.g, e));
}
function di(t, e, n) {
	return (5 === t.h || 2 === t.h) && (e = un(e, 0 | e[Q], n),
		2 == t.h ? Jn(t, Dn, e) : e.push(Dn(t.g)),
		!0);
}
var pi = ei((function (t, e, n) {
	return 5 === t.h && (ri(e, n, Dn(t.g)),
		!0);
}
), si, br)
	, gi = ni(di, (function (t, e, n) {
		if(null != (e = ti($t, e)))
	...
	, yi = ei((function (t, e, n) {
		return 5 === t.h && (ri(e, n, 0 === (t = Dn(t.g)) ? void 0 : t),
			!0);
	}
	), si, br)
	, _i = ei((function (t, e, n) {
		return 0 !== t.h ? t = !1 : (ri(e, n, Cn(t.g, Nt)),
			t = !0),
			t;
	}
	), oi, Tr)
	, vi = ei((function (t, e, n) {
		return 0 !== t.h ? e = !1 : (ri(e, n, (t = Cn(t.g, Nt)) === Qr ? void 0 : t),
			e = !0),
			e;
	}
	), oi, Tr)
	, Ei = ei((function (t, e, n) {
		return 0 !== t.h ? t = !1 : (ri(e, n, Cn(t.g, Ot)),
			t = !0),
			t;
	}
	), (function (t, e, n) {
		if(e = function (t) {
			...
			if(te(t)) {
				if("string" === e)
					return e = Kt(Number(t)),
						Wt(e) && e >= 0 ? t = String(e) : (-1 !== (e = t.indexOf(".")) && (t = t.substring(0, e)),
							(e = "-" !== t[0] && ((e = t.length) < 20 || 20 === e && t <= "18446744073709551615")) || (Gt(t),
								t = Ut(Rt, It))),
						t;
				if("number" === e)
					return (t = Kt(t)) >= 0 && Wt(t) || (Mt(t),
						t = Ct(Rt, It)),
						t;
			}
		}(e),
			...
			if(null != e)
				...
				typeof e) {
					...
					case "bigint":
						n = BigInt.asUintN(64, e),
							n = new er(Number(n & BigInt(4294967295)), Number(n >> BigInt(32))),
							or(t.g, n.h, n.g);
						break;
					default:
						n = tr(e),
	...
	, wi = ei((function (t, e, n) {
		return 0 === t.h && (ri(e, n, Nn(t.g)),
			!0);
	}
	), ai, Er)
	, Ti = ni((function (t, e, n) {
		return (0 === t.h || 2 === t.h) && (e = un(e, 0 | e[Q], n),
	...
	, Ai = ei((function (t, e, n) {
		return 0 === t.h && (ri(e, n, 0 === (t = Nn(t.g)) ? void 0 : t),
			!0);
	}
	), ai, Er)
	, bi = ei((function (t, e, n) {
		return 0 === t.h && (ri(e, n, On(t.g)),
			!0);
	}
	), ci, _r)
	, ki = ei((function (t, e, n) {
		return 0 === t.h && (ri(e, n, !1 === (t = On(t.g)) ? void 0 : t),
			!0);
	}
	), ci, _r)
	, Si = ni((function (t, e, n) {
		return 2 === t.h && (t = qn(t),
			un(e, 0 | e[Q], n).push(t),
			!0);
	}
	...
	, xi = ei((function (t, e, n) {
		return 2 === t.h && (ri(e, n, "" === (t = qn(t)) ? void 0 : t),
			!0);
	}
	), hi, vr)
	, Li = ei((function (t, e, n) {
		return 2 === t.h && (ri(e, n, qn(t)),
			!0);
	}
	), hi, vr)
	...
	, Ii = Ir((function (t, e, n, r, i, s) {
		if(2 !== t.h)
			return !1;
		let o = 0 | e[Q];
		return dn(e, o, s, n, pt(o)),
			Yn(t, e = gn(e, r, n), i),
			!0;
	}
	), ui)
	, Fi = ei((function (t, e, n) {
		return 2 === t.h && (ri(e, n, $n(t)),
			!0);
	}
	), li, kr)
	, Mi = ni((function (t, e, n) {
		return (0 === t.h || 2 === t.h) && (e = un(e, 0 | e[Q], n),
	...
	, Pi = ei((function (t, e, n) {
		return 0 === t.h && (ri(e, n, 0 === (t = Un(t.g)) ? void 0 : t),
			!0);
	}
	), fi, wr)
	, Ci = ei((function (t, e, n) {
		return 0 === t.h && (ri(e, n, Nn(t.g)),
			!0);
	}
	), (function (t, e, n) {
		null != (e = ee(e)) && (e = parseInt(e, 10),
			lr(t, n, 0),
			cr(t.g, e));
	}
	), Sr);
...
var Bi = class extends Lr {
	...
	, Gi = [0, xi, ei((function (t, e, n) {
		return 2 === t.h && (ri(e, n, (t = $n(t)) === R() ? void 0 : t),
			!0);
	}
	), (function (t, e, n) {
		if(null != e) {
			if(e instanceof Lr) {
				const r = e.Ra;
				return void (r ? (e = r(e),
					null != e && pr(t, n, Pn(e, !0).buffer)) : U(K, 3));
			}
			if(Array.isArray(e))
				return void U(K, 3);
		}
...
function Hi(t, ...e) {
	...
	let n = t[0];
	for(let r = 0; r < e.length; r++)
		n += encodeURIComponent(e[r]) + t[r + 1];
	return Xi(n);
}
var Wi = [0, wi, Ci, bi, -1, Ti, Ci, -1, bi]
	...
	, Ki = [0, bi, Li, bi, Ci, -1, ni((function (t, e, n) {
		return (0 === t.h || 2 === t.h) && (e = un(e, 0 | e[Q], n),
	...
	, Yi = [0, 3, bi, -1, 2, [0, [2], wi, Ii, [0, ei((function (t, e, n) {
		return 0 === t.h && (ri(e, n, Un(t.g)),
			!0);
	}
...
var qs = Ui(class extends Lr {
	...
	, Zs = [0, Ws, pi, [0, Ws], bi]
	, Qs = Ni(508968150, Js);
ts[508968150] = [0, Ws, Ks, Zs, pi, [0, [0, Hs]]],
	ts[508968149] = Zs;
...
var Oo = class extends Lr {
	...
	, No = Ni(443442058, Oo);
ts[443442058] = [0, Ws, Li, wi, pi, Si, -1, bi, pi],
	ts[514774813] = _o;
var Uo = class extends Lr {
	...
	, Do = Ni(516587230, Uo);
function Bo(t, e) {
	return e = e ? e.clone() : new Ns,
		void 0 !== t.displayNamesLocale ? Ze(e, 1, ue(t.displayNamesLocale)) : void 0 === t.displayNamesLocale && Ze(e, 1),
		void 0 !== t.maxResults ? xn(e, 2, t.maxResults) : "maxResults" in t && Ze(e, 2),
		void 0 !== t.scoreThreshold ? Ln(e, 3, t.scoreThreshold) : "scoreThreshold" in t && Ze(e, 3),
		void 0 !== t.categoryAllowlist ? In(e, 4, t.categoryAllowlist) : "categoryAllowlist" in t && Ze(e, 4),
		void 0 !== t.categoryDenylist ? In(e, 5, t.categoryDenylist) : "categoryDenylist" in t && Ze(e, 5),
		e;
}
function Go(t) {
	const e = Number(t);
...
function Vo(t) {
	...
	return null != function (t) {
		return null == t ? t : "bigint" == typeof t ? (wt(t) ? t = Number(t) : (t = Xt(64, t),
			t = wt(t) ? Number(t) : String(t)),
			t) : te(t) ? "number" == typeof t ? ie(t) : se(t) : void 0;
	}($e(t, 2, void 0, void 0, ce)) && (e.timestampMs = Go($e(t, 2, void 0, void 0, ce) ?? Ye)),
		e;
}
function Xo(t) {
	var e = en(t, 3, $t, tn())
...
let Yo;
ts[516587230] = [0, Ws, _o, vo, pi],
	ts[518928384] = vo;
const qo = new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 96, 0, 1, 123, 3, 2, 1, 0, 10, 10, 1, 8, 0, 65, 0, 253, 15, 253, 98, 11]);
async function $o(t) {
	if(t)
		return !0;
	if(void 0 === Yo)
		try {
			await WebAssembly.instantiate(qo),
				Yo = !0;
		} catch {
			Yo = !1;
		}
...
/**
 * Binds an image asset to an active WebGL texture and adjusts canvas constraints.
 * * @param {Object} glManager - The engine's internal WebGL state/context manager (t).
 * @param {HTMLImageElement|ImageBitmap|OffscreenCanvas} imageSource - The pixel payload to upload (e).
 * @param {WebGLTexture|null} targetStream - Optional texture stream binding override (n).
 * @returns {number[]} The computed width and height tracking parameters.
 */
function ra(glManager, imageSource, targetStream) {
	const internalGL = glManager.i;

	// 1. Ensure context target exists
	if(!internalGL.canvas) {
		throw new Error("No OpenGL canvas configured.");
	}

	// 2. Bind the backing pipeline
	if(targetStream) {
		internalGL._bindTextureToStream(targetStream);
	} else {
		internalGL._bindTextureToCanvas();
	}

	// 3. Extract the context without mutating underlying object prototypes
	const gl = internalGL.canvas.getContext("webgl2") || internalGL.canvas.getContext("webgl");
	if(!gl) {
	...
	// 4. Handle vertical axis flipping for target GPU coordinate streams
	if(internalGL.gpuOriginForWebTexturesIsBottomLeft) {
		gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL, true);
	}

	// 5. Fire the raw pixel buffer array straight to the GPU
	gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, imageSource);

	// 6. Restore pixel storage packing state
	if(internalGL.gpuOriginForWebTexturesIsBottomLeft) {
		gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL, false);
	}

	// 7. Calculate new dimensional boundaries
	const [sourceWidth, sourceHeight] = ea(imageSource);

	// 8. Conditionally match canvas backing store scale changes
	if(glManager.l) {
		const dimensionsMatch = sourceWidth === internalGL.canvas.width && sourceHeight === internalGL.canvas.height;
		if(!dimensionsMatch) {
			internalGL.canvas.width = sourceWidth;
			internalGL.canvas.height = sourceHeight;
		}
	}
...
function ca(t, e) {
	...
	"string" == typeof e ? (Ze(n, 2, ue(e)),
		Ze(n, 1)) : e instanceof Uint8Array && (Ze(n, 1, ht(e, !1)),
			Ze(n, 2)),
...
function ha(t) {
	try {
		const e = t.H.length;
		if(1 === e)
			throw Error(t.H[0].message);
		if(e > 1)
			throw Error("Encountered multiple errors: " + t.H.map((t => t.message)).join(", "));
	} finally {
		t.H = [];
	}
}
...
var pa = class {
	...
	l(t, e = !0) {
		if(e) {
			...
			if(!(yn(this.baseOptions, Vs, 1)?.g() || yn(this.baseOptions, Vs, 1)?.l() || t.baseOptions?.modelAssetBuffer || t.baseOptions?.modelAssetPath))
...
var ba = class {
	...
	m() {
		const t = this.g;
		if(this.h = ga(t.createProgram(), "Failed to create WebGL program"),
	...
	close() {
		if(this.h) {
			...
			t.deleteProgram(this.h),
				t.deleteShader(this.X),
				t.deleteShader(this.W);
		}
...
var ka = class extends ba {
	...
	m() {
		super.m();
		const t = this.g;
		this.P = ga(t.getUniformLocation(this.h, "backgroundTexture"), "Uniform location"),
			this.U = ga(t.getUniformLocation(this.h, "colorMappingTexture"), "Uniform location"),
			this.M = ga(t.getUniformLocation(this.h, "maskTexture"), "Uniform location");
	}
	l() {
		super.l();
		const t = this.g;
		t.uniform1i(this.M, 0),
			t.uniform1i(this.P, 1),
	...
	, Sa = class extends ba {
		...
		m() {
			super.m();
			const t = this.g;
			this.M = ga(t.getUniformLocation(this.h, "defaultTexture"), "Uniform location"),
				this.P = ga(t.getUniformLocation(this.h, "overlayTexture"), "Uniform location"),
				this.I = ga(t.getUniformLocation(this.h, "maskTexture"), "Uniform location");
		}
		l() {
			super.l();
			const t = this.g;
...
function Ia(t) {
	...
	return t.h || (t.h = ga(t.canvas.getContext("webgl2"), "You cannot use a canvas that is already bound to a different type of rendering context.")),
		t.h;
}
function Fa(t) {
	if(t = Ia(t),
...
function Pa(t) {
	...
	let n = xa(t, 2);
	return n || (n = wa(Ma(t), e, t.m ? e.LINEAR : e.NEAREST),
		t.g.push(n),
		t.j = !0),
...
var Oa, Na = class {
	constructor(t, e, n, r, i, s, o) {
		this.g = t,
			...
			this.width = s,
			this.height = o,
			this.j && (0 === --Ua && console.error("You seem to be creating MPMask instances without invoking .close(). This leaks resources."));
	}
	Fa() {
		return !!xa(this, 0);
	}
	...
	close() {
		this.j && Ia(this).deleteTexture(xa(this, 2)),
			Ua = -1;
	}
}
	;
				...
				t.I && function (t, e) {
					...
					for(const [n, r] of t) {
						...
						if(s.done)
							return !1;
						const [o, a] = s.value;
						if(t !== o || i[0] !== a[0] || i[1] !== a[1] || i[2] !== a[2] || i[3] !== a[3])
							return !1;
					}
					return !!e.next().done;
				}(t.I, r))
...
var Ka = class {
	constructor(t, e) {
		"undefined" != typeof CanvasRenderingContext2D && t instanceof CanvasRenderingContext2D || t instanceof OffscreenCanvasRenderingContext2D ? (this.l = t,
			this.j = e) : this.j = t;
	}
	ya(t, e) {
		if(t) {
	...
	va(t, e, n = [0, 0, 0, 255]) {
		this.l ? function (t, e, n, r) {
			...
			Ha(t, e, (e => {
				Wa(t, e, n, r),
					(e = Va(t)).drawImage(i.canvas, 0, 0, e.canvas.width, e.canvas.height);
			}
			));
...
var nc = class {
	constructor(t, e, n, r, i, s, o) {
		this.g = t,
			...
			this.width = s,
			this.height = o,
			(this.j || this.m) && (0 === --rc && console.error("You seem to be creating MPImage instances without invoking .close(). This leaks resources."));
	}
	Ea() {
		return !!Ya(this, 0);
	}
...
const sc = function (t) {
	...
	addUintVectorToStream(t, e, n) {
		na(this, e, (e => {
			...
			for(const e of t)
				this.i._addUintVectorEntry(r, e);
	...
	addUintVectorToInputSidePacket(t, e) {
		na(this, e, (e => {
			...
			if(!n)
				throw Error("Unable to allocate new unsigned int vector on heap.");
			for(const e of t)
				this.i._addUintVectorEntry(n, e);
...
var oc, ac = class extends sc {
	...
	;
/**
 * Normalized MediaPipe canvas context initializer.
 * Handles fallback cross-thread canvas provisioning cleanly.
 */
async function cc(t, e, n) {
	// 1. Resolve target canvas context using explicit checks
	let targetCanvas = n.canvas;

	if(!targetCanvas) {
		debugger;
		if(Qo()) {
			// Context behaves as detached or headless (e.g., explicit worker setup)
			targetCanvas = undefined;
		} else if(typeof document !== 'undefined' && document.createElement) {
			// Main-thread DOM fallback
			targetCanvas = document.createElement("canvas");
		} else if(typeof OffscreenCanvas !== 'undefined') {
			// Worker thread native fallback
			targetCanvas = new OffscreenCanvas(300, 150);
		}
	}

	// 2. Direct, un-nested execution handoff to primary runner
	return aa(t, targetCanvas, e, n);
}
function hc(t, e, n, r) {
	if(t.U) {
		const s = new Ls;
		...
		if(n?.rotationDegrees) {
			...
			if(Ln(s, 5, -Math.PI * n.rotationDegrees / 180),
	...
	t.g.pa(e, t.X, r ?? performance.now()),
		t.finishProcessing();
}
function uc(t, e, n) {
	if(t.baseOptions?.g())
...
function fc(t, e, n, r) {
	...
	return t = new Na([i], n, !1, t.g.i.canvas, t.P, s, e),
		r ? t.clone() : t;
}
var dc = class extends pa {
	...
	l(t, e = !0) {
		if("runningMode" in t && Ze(this.baseOptions, 2, Jt(!!t.runningMode && "IMAGE" !== t.runningMode)),
...
var pc = class extends dc {
	...
	o(t) {
		return "minDetectionConfidence" in t && Ln(this.h, 2, t.minDetectionConfidence ?? .5),
			"minSuppressionThreshold" in t && Ln(this.h, 3, t.minSuppressionThreshold ?? .3),
			this.l(t);
	}
	F(t, e) {
		return this.j = {
...
var Sc = class extends dc {
	...
	o(t) {
		return "numFaces" in t && xn(this.u, 4, t.numFaces ?? 1),
			"minFaceDetectionConfidence" in t && Ln(this.u, 2, t.minFaceDetectionConfidence ?? .5),
			"minTrackingConfidence" in t && Ln(this.h, 4, t.minTrackingConfidence ?? .5),
			"minFacePresenceConfidence" in t && Ln(this.A, 2, t.minFacePresenceConfidence ?? .5),
	...
	m() {
		...
		Rn(n, 2, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"),
			...
			this.g.attachProtoVectorListener("face_landmarks", ((t, e) => {
				for(const e of t)
					t = ks(e),
						this.j.faceLandmarks.push(Ho(t));
				ua(this, e);
			}
			)),
			...
			this.outputFacialTransformationMatrixes && (us(t, "face_geometry"),
				...
				this.g.attachProtoVectorListener("face_geometry", ((t, e) => {
					if(this.outputFacialTransformationMatrixes)
						for(const e of t)
							(t = yn(t = qs(e), Ss, 2)) && this.j.facialTransformationMatrixes.push({
								rows: kn(t, 1) ?? 0 ?? 0,
								columns: kn(t, 2) ?? 0 ?? 0,
...
var Fc = class extends dc {
	...
	o(t) {
		if(xn(this.A, 3, t.numHands ?? 1),
			"minHandDetectionConfidence" in t && Ln(this.A, 2, t.minHandDetectionConfidence ?? .5),
			"minTrackingConfidence" in t && Ln(this.u, 4, t.minTrackingConfidence ?? .5),
			"minHandPresenceConfidence" in t && Ln(this.D, 2, t.minHandPresenceConfidence ?? .5),
		...
		return t.customGesturesClassifierOptions ? (wn(n = e = new to, 0, 2, r = Bo(t.customGesturesClassifierOptions, yn(this.h, to, 4)?.l())),
			wn(this.h, 0, 4, e)) : void 0 === t.customGesturesClassifierOptions && yn(this.h, to, 4)?.g(),
			this.l(t);
	}
	Ha(t, e) {
		return Lc(this),
...
var Pc = class extends dc {
	...
	o(t) {
		return "numHands" in t && xn(this.j, 3, t.numHands ?? 1),
			"minHandDetectionConfidence" in t && Ln(this.j, 2, t.minHandDetectionConfidence ?? .5),
			"minTrackingConfidence" in t && Ln(this.h, 4, t.minTrackingConfidence ?? .5),
			"minHandPresenceConfidence" in t && Ln(this.u, 2, t.minHandPresenceConfidence ?? .5),
			this.l(t);
	}
	F(t, e) {
...
var Dc = class extends dc {
	...
	o(t) {
		return "minFaceDetectionConfidence" in t && Ln(this.u, 2, t.minFaceDetectionConfidence ?? .5),
			"minFaceSuppressionThreshold" in t && Ln(this.u, 3, t.minFaceSuppressionThreshold ?? .3),
			"minFacePresenceConfidence" in t && Ln(this.O, 2, t.minFacePresenceConfidence ?? .5),
			"outputFaceBlendshapes" in t && (this.outputFaceBlendshapes = !!t.outputFaceBlendshapes),
			"minPoseDetectionConfidence" in t && Ln(this.A, 2, t.minPoseDetectionConfidence ?? .5),
			"minPoseSuppressionThreshold" in t && Ln(this.A, 3, t.minPoseSuppressionThreshold ?? .3),
			"minPosePresenceConfidence" in t && Ln(this.M, 2, t.minPosePresenceConfidence ?? .5),
			"outputPoseSegmentationMasks" in t && (this.outputPoseSegmentationMasks = !!t.outputPoseSegmentationMasks),
			"minHandLandmarksConfidence" in t && Ln(this.I, 2, t.minHandLandmarksConfidence ?? .5),
			this.l(t);
	}
	F(t, e, n) {
		const r = "function" != typeof e ? e : {};
		return this.D = "function" == typeof e ? e : n,
			Oc(this),
			uc(this, t, r),
			Nc(this);
	}
	G(t, e, n, r) {
		...
		return this.D = "function" == typeof n ? n : r,
			Oc(this),
			lc(this, t, i, e),
			Nc(this);
	}
	m() {
		...
		const e = new Qi
			, n = new Bi;
		Rn(n, 1, "type.googleapis.com/mediapipe.tasks.vision.holistic_landmarker.proto.HolisticLandmarkerGraphOptions"),
			function (t, e) {
				if(null != e)
					if(Array.isArray(e))
						Ze(t, 2, Ie(e, 0, Me));
						...
						if(!("string" == typeof e || e instanceof F || x(e)))
							throw Error("invalid value in Any.value field: " + e + " expected a ByteString, a base64 encoded string, a Uint8Array or a jspb array");
						hn(t, 2, ht(e, !1), R());
					}
			}(n, this.j.g());
		const r = new is;
		Rn(r, 2, "mediapipe.tasks.vision.holistic_landmarker.HolisticLandmarkerGraph"),
			bn(r, 8, Bi, n),
			...
			this.outputPoseSegmentationMasks && (rs(r, "POSE_SEGMENTATION_MASK:pose_segmentation_mask"),
			...
			this.g.attachProtoListener("right_hand_landmarks", ((t, e) => {
				Uc(t, this.h.rightHandLandmarks),
					ua(this, e);
			}
			)),
...
var Bc = class extends dc {
	...
	o(t) {
		return wn(this.h, 0, 2, Bo(t, yn(this.h, Ns, 2))),
			this.l(t);
	}
	sa(t, e) {
		return this.j = {
...
var Gc = class extends dc {
	...
	o(t) {
		var e = this.h
			, n = yn(this.h, Ds, 2);
		return n = n ? n.clone() : new Ds,
			void 0 !== t.l2Normalize ? Ze(n, 1, Jt(t.l2Normalize)) : "l2Normalize" in t && Ze(n, 1),
			void 0 !== t.quantize ? Ze(n, 2, Jt(t.quantize)) : "quantize" in t && Ze(n, 2),
			wn(e, 0, 2, n),
			this.l(t);
	}
	za(t, e) {
					...
					this.embeddings = function (t) {
						return {
							embeddings: vn(t, Ps, 1).map((t => {
								...
								var n = t.v;
								return void 0 !== mn(n, 0 | n[Q], Fs, ln(t, 1)) ? (t = en(t = yn(t, Fs, ln(t, 1), void 0), 1, $t, tn()),
									e.floatEmbedding = t.slice()) : (n = new Uint8Array(0),
										e.quantizedEmbedding = yn(t, Ms, ln(t, 2), void 0)?.na()?.h() ?? n),
									e;
							}
							)),
...
var Wc = class extends dc {
	...
	o(t) {
		return void 0 !== t.displayNamesLocale ? Ze(this.h, 2, ue(t.displayNamesLocale)) : "displayNamesLocale" in t && Ze(this.h, 2),
	...
	m() {
		...
		Rn(n, 2, "mediapipe.tasks.vision.image_segmenter.ImageSegmenterGraph"),
			...
			cs(t, n),
			la(this, t),
			this.outputConfidenceMasks && (us(t, "confidence_masks"),
...
var Kc = class extends dc {
	...
	segment(t, e, n, r) {
		const i = "function" != typeof n ? n : {};
		if(this.j = "function" == typeof n ? n : r,
		...
		this.g.addProtoToStream(r.g(), "mediapipe.tasks.vision.interactive_segmenter.proto.RegionOfInterest", "roi_in", n),
			uc(this, t, i);
		t: {
			try {
...
var Yc = class extends dc {
	...
	o(t) {
		return void 0 !== t.displayNamesLocale ? Ze(this.h, 2, ue(t.displayNamesLocale)) : "displayNamesLocale" in t && Ze(this.h, 2),
			void 0 !== t.maxResults ? xn(this.h, 3, t.maxResults) : "maxResults" in t && Ze(this.h, 3),
			void 0 !== t.scoreThreshold ? Ln(this.h, 4, t.scoreThreshold) : "scoreThreshold" in t && Ze(this.h, 4),
			void 0 !== t.categoryAllowlist ? In(this.h, 5, t.categoryAllowlist) : "categoryAllowlist" in t && Ze(this.h, 5),
			void 0 !== t.categoryDenylist ? In(this.h, 6, t.categoryDenylist) : "categoryDenylist" in t && Ze(this.h, 6),
			this.l(t);
	}
	F(t, e) {
		return this.j = {
...
var Zc = class extends dc {
	...
	o(t) {
		return "numPoses" in t && xn(this.j, 4, t.numPoses ?? 1),
			"minPoseDetectionConfidence" in t && Ln(this.j, 2, t.minPoseDetectionConfidence ?? .5),
			"minTrackingConfidence" in t && Ln(this.h, 4, t.minTrackingConfidence ?? .5),
			"minPosePresenceConfidence" in t && Ln(this.A, 2, t.minPosePresenceConfidence ?? .5),
	...
	m() {
		...
		Rn(n, 2, "mediapipe.tasks.vision.pose_landmarker.PoseLandmarkerGraph"),
			...
			this.outputSegmentationMasks && (rs(n, "SEGMENTATION_MASK:segmentation_masks"),
