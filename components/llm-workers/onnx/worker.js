...
function loadONNXEngine() {
    ...
    importScripts('/components/llm-workers/onnx/ort.webgpu.min.js');
    importScripts('/components/llm-workers/onnx/web-tokenizers.js');
    ...
    ort.env.webgpu.wasmPaths = '/components/llm-workers/onnx/';

    ort.env.wasm.numThreads = 4;
    ort.env.wasm.proxy = false;
    ort.env.wasm.wasmPaths = '/components/llm-workers/onnx/';
}
